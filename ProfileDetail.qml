...
Popup {
  ...
  Column { anchors.fill: parent; spacing: Style.space(8)
    Row { width: parent.width; spacing: Style.space(8)
      ...
      Button { visible: !root.globalScope && !root.showOverride; text: root.showRuntime ? (root.svc ? root.svc.t("viewSource") : "View Source") : (root.svc ? root.svc.t("viewRuntime") : "View Runtime"); onClicked: { root.showRuntime = !root.showRuntime; root.showOverride = false; root.load() } }
